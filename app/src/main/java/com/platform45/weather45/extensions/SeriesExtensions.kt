...
fun Series.toPairHistoryTable() = PairHistoryTable(`startDate` = this.startDate, `endDate` = this.endDate)

fun PairHistoryTable.toSeries() = Series(this.startDate, this.endDate, null, null)
